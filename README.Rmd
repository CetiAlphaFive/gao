...
`gao` provides tools for downloading reports published by the United States
Government Accountability Office (GAO). It ships with a bundled dataset of
over 55,000 report URLs (1921--present, updated daily via GitHub Actions) and
a one-step function for batch downloading reports as PDF or HTML.

**Disclaimer:** This package is not affiliated with, endorsed by, or in any
way officially connected to the U.S. Government Accountability Office. All
